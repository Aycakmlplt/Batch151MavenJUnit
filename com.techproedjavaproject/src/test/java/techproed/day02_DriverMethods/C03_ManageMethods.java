...
public class C03_ManageMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Browser'ı maximize yapalım//*** bizi en cok ilgilendiren bu kisim digerleri developer'in isi.
    ...
    ulaşmada işimizi kolaylaştırır. Böylelikle fail almamış oluruz
       */
        ...
        Thread.sleep(3000);
        driver.manage().window().setPosition(new Point(50,50));//istediğimiz konuma getirir(pencereyi ordan oraya getirir)//import ederken seleniumdan et
        driver.manage().window().setSize(new Dimension(600,600));//istediğimiz size'a getirir(sayfayi alt koseden buyutmek gibi)//import ederken seleniumdan et
